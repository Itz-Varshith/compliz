...
export default function HomePage() {
  ...
  return (
    <div className="h-[calc(100vh-4rem)] bg-background font-mono">
      {/* Hero Section */}
      <section className="relative px-4 pt-10 pb-15 overflow-hidden bg-orange-500/7 dark:bg-orange-500/10">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-20">
            <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold tracking-widest mb-4">
              ...
              <span className="text-foreground ml-2">compliz</span>
            </h1>
          ...
          <div className="text-center max-w-4xl mx-auto space-y-8">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground leading-tight tracking-wide">
              <span className="text-orange-500">//</span> Elevate Your Coding
              Journey
            </h2>

            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-2xl mx-auto tracking-wide">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-orange-500 text-orange-600 dark:text-orange-400 hover:bg-orange-500 hover:text-white hover:border-orange-600 font-semibold text-base px-10 py-6 rounded-none bg-background transition-all tracking-wider"
                asChild
              >
      ...
      {/* Features Section */}
      <section className="px-4 py-20 bg-orange-50/30 dark:bg-orange-950/10 border-y-2 border-orange-500/20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h3 className="text-3xl md:text-4xl font-bold text-foreground mb-4 tracking-wide">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div
              onClick={handleStartPracticing}
              className="group relative bg-card border-2 border-orange-500/20 rounded-none p-8 hover:border-orange-500 hover:shadow-xl hover:shadow-orange-500/10 transition-all duration-300 cursor-pointer"
            >
              ...
              <div className="relative">
                ...
                <h4 className="font-bold text-xl mb-3 text-card-foreground tracking-wide">
                  Practice_Problems
                </h4>
            ...
            <div className="group relative bg-card border-2 border-orange-500/20 rounded-none p-8 hover:border-orange-500 hover:shadow-xl hover:shadow-orange-500/10 transition-all duration-300 cursor-pointer">
              <Link href="/compiler">
                <div className="absolute top-2 right-2 text-orange-500/20 text-xs font-bold">
                  02
                </div>
      ...
      <section className="px-4 py-20 bg-background">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center space-y-4 p-8 border-2 border-orange-500/10 bg-orange-50/20 dark:bg-orange-950/10 hover:border-orange-500/30 hover:bg-orange-50/40 dark:hover:bg-orange-950/20 transition-all">
              <div className="w-16 h-16 bg-background border-2 border-orange-500/30 flex items-center justify-center mx-auto">
                <Target className="w-8 h-8 text-orange-500" />
              </div>
              <h4 className="font-bold text-xl text-foreground tracking-wide">
                Focused_Learning
              </h4>
          ...
          <div className="text-center mt-8">
            <h3 className="text-3xl md:text-4xl font-bold text-foreground tracking-wide">
              <span className="text-orange-500">{"}"}</span>
            </h3>
          </div>
        </div>
