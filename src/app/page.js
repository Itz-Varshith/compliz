...
import { Code2, Zap, Trophy, Users, Sparkles, ChevronRight, Award, Target, Rocket, Terminal } from "lucide-react"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-20">
            ...
            <div className="flex items-center justify-center gap-2 mt-4">
              ...
              <span className="text-orange-500/70 text-sm tracking-wider">ONLINE CODING PLATFORM</span>
          ...
          <div className="text-center max-w-4xl mx-auto space-y-8">
            ...
            <p className="text-lg md:text-xl text-gray-600 leading-relaxed max-w-2xl mx-auto tracking-wide">
              A comprehensive platform designed for developers who aspire to master algorithms, 
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto tracking-wide">
              Powerful tools and resources crafted to accelerate your learning and growth
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div onClick={handleStartPracticing} className="group relative bg-white border-2 border-orange-500/20 rounded-none p-8 hover:border-orange-500 hover:shadow-xl hover:shadow-orange-500/10 transition-all duration-300">
              <div className="absolute top-2 right-2 text-orange-500/20 text-xs font-bold">01</div>
              <div className="relative">
                ...
                <h4  className="font-bold text-xl mb-3 text-gray-900 tracking-wide">Practice_Problems</h4>
                <p className="text-gray-600 leading-relaxed text-sm">
                  Curated coding challenges ranging from beginner to expert level
                </p>
              </div>
            </div>
            ...
            <div className="group relative bg-white border-2 border-orange-500/20 rounded-none p-8 hover:border-orange-500 hover:shadow-xl hover:shadow-orange-500/10 transition-all duration-300">
              <Link href="/compiler">
              <div className="absolute top-2 right-2 text-orange-500/20 text-xs font-bold">02</div>
              <div className="relative">
                <div className="w-14 h-14 bg-orange-500/10 border-2 border-orange-500/30 flex items-center justify-center mb-6 group-hover:bg-orange-500 transition-all duration-300">
                  <Zap className="w-7 h-7 text-orange-500 group-hover:text-white transition-colors" />
                </div>
                <h4 className="font-bold text-xl mb-3 text-gray-900 tracking-wide">Online_Compiler</h4>
                <p className="text-gray-600 leading-relaxed text-sm">
            ...
            <div onClick={handleShowProgress} className="group relative bg-white border-2 border-orange-500/20 rounded-none p-8 hover:border-orange-500 hover:shadow-xl hover:shadow-orange-500/10 transition-all duration-300">
              <div  className="absolute top-2 right-2 text-orange-500/20 text-xs font-bold">03</div>
              <div className="relative">
                <div className="w-14 h-14 bg-orange-500/10 border-2 border-orange-500/30 flex items-center justify-center mb-6 group-hover:bg-orange-500 transition-all duration-300">
                  <Trophy className="w-7 h-7 text-orange-500 group-hover:text-white transition-colors" />
                </div>
                <h4 className="font-bold text-xl mb-3 text-gray-900 tracking-wide">Track_Progress</h4>
                <p className="text-gray-600 leading-relaxed text-sm">
            ...
            <div onClick={handleCreateQuestion} className="group relative bg-white border-2 border-orange-500/20 rounded-none p-8 hover:border-orange-500 hover:shadow-xl hover:shadow-orange-500/10 transition-all duration-300">
              <div className="absolute top-2 right-2 text-orange-500/20 text-xs font-bold">04</div>
              <div className="relative">
                <div className="w-14 h-14 bg-orange-500/10 border-2 border-orange-500/30 flex items-center justify-center mb-6 group-hover:bg-orange-500 transition-all duration-300">
                  <Users className="w-7 h-7 text-orange-500 group-hover:text-white transition-colors" />
                </div>
                <h4 className="font-bold text-xl mb-3 text-gray-900 tracking-wide">Create_Questions</h4>
                <p className="text-gray-600 leading-relaxed text-sm">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center space-y-4 p-8 border-2 border-orange-500/10 bg-orange-50/20 hover:border-orange-500/30 hover:bg-orange-50/40 transition-all">
              ...
              <h4 className="font-bold text-xl text-gray-900 tracking-wide">Focused_Learning</h4>
              <p className="text-gray-600 text-sm leading-relaxed">
                Structured curriculum designed to build strong fundamentals and advanced skills
              </p>
            </div>
            ...
            <div className="text-center space-y-4 p-8 border-2 border-orange-500/10 bg-orange-50/20 hover:border-orange-500/30 hover:bg-orange-50/40 transition-all">
              ...
              <h4 className="font-bold text-xl text-gray-900 tracking-wide">Fast_Execution</h4>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div className="text-center space-y-4 p-8 border-2 border-orange-500/10 bg-orange-50/20 hover:border-orange-500/30 hover:bg-orange-50/40 transition-all">
              ...
              <h4 className="font-bold text-xl text-gray-900 tracking-wide">Quality_Content</h4>
              <p className="text-gray-600 text-sm leading-relaxed">
    ...
    <div className="grid md:grid-cols-3 gap-12">
      ...
      <div className="space-y-4">
        ...
        <p className="text-slate-400 text-sm leading-relaxed pr-4">
          A comprehensive platform designed for developers who aspire to master algorithms, solve complex problems, and build their skills with confidence.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center space-x-4">
          ...
          <a href="#" className="text-slate-400 hover:text-primary transition-colors duration-200" aria-label="Instagram">
    ...
    <div className="mt-16 pt-8 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between text-sm text-slate-500">
      ...
      <div className="flex items-center gap-2 mt-4 sm:mt-0">
        ...
        <div className="flex items-center gap-2 text-slate-300 font-bold tracking-wide">
          ...
          <span className="hover:text-primary transition-colors cursor-default">HARSHITH</span>
        </div>
      </div>
    </div>
  </div>
