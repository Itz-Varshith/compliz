  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {isLoading ? (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
            <Loader2 size={48} className="mx-auto mb-4 text-orange-600 animate-spin" />
            <h3 className="text-xl font-semibold text-gray-800 mb-2">Loading questions...</h3>
            <p className="text-gray-600">Please wait while we fetch the problems</p>
          </div>
        ) : error ? (
          <div className="bg-white rounded-lg shadow-sm border border-red-200 p-12 text-center">
            <Code2 size={48} className="mx-auto mb-4 text-red-400" />
            <h3 className="text-xl font-semibold text-red-800 mb-2">Error loading questions</h3>
