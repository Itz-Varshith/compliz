...
//       const list = Array.isArray(raw) ? raw : raw?.submissions || raw?.data || []
...
//           status: s.status?.name || s.status || s.verdict || "Unknown",
//           runtime: runtimeMs,
//           memory: memoryText,
//           language: s.language?.name || s.lang || s.language || "Unknown",
//         }
//       })
    ...
    try {
      ...
      const normalized = (list || []).map((s, idx) => {
        ...
        return {
          ...
          runtime: runtimeMs,
          memory: memoryText,
          language: s.language?.name || s.langId || s.lang || s.language || "Unknown", // support langId from pasted.txt
        }
      })
