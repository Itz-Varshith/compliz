...
export default function SolvePage({ params }) {
    ...
    const fetchQuestion = async () => {
      try {
        ...
        if (data.success && data.questionData) {
          ...
          setBoilerPlateCodes(data.questionData.boilerPlateCodes || []);
          setSubmissions([]);
        } else {
  ...
  // Initialize language and code when boilerplate codes are loaded
  useEffect(() => {
  ...
  // Dynamic language options based on available boilerplate codes
  const languageOptions = boilerPlateCodes.map((bp) => ({
    value: bp.language,
    label: bp.language,
  }));
  ...
  const handleLanguageChange = (newLang) => {
    ...
    const selectedBoilerPlate = boilerPlateCodes.find(
        ...
        <div className="bg-muted/30 px-4 py-3 flex items-center justify-between border-b border-border shrink-0">
          ...
          <div className="flex gap-2 relative">
            <Button
              ...
              title={
                languageOptions.length === 0
                  ...
                  : "Run locally against sample tests"
              }
            >
              <Play size={16} />
            ...
            <Button
              onClick={submitCode}
              disabled={
                isSubmitting || !isAuthenticated || languageOptions.length === 0
              }
              size="sm"
            ...
            <div className="flex items-center justify-center h-full bg-muted/30">
              <div className="text-center p-8">
                ...
                <p className="text-muted-foreground text-sm">
                  This question doesn't have any boilerplate code templates
                  available.
                </p>
              </div>
            </div>
