...
// import { createClient } from "@/lib/supabase/client"
// import { useRouter } from "next/navigation"
// import { copyToClipboard } from "@/components/copyToClipboard.jsx" // Import copyToClipboard function
// import {
//   LineChart,
//   Line,
//   BarChart,
...
//   } = useSWR(user ? [`${API_BASE}/code`, accessToken] : null, ([url, token]) => fetchJson(url, token), {
//     revalidateOnFocus: false,
//   })

//   const submissionsList = Array.isArray(submissionsRaw) ? submissionsRaw.map(toSubmission) : []
//   const savedCodesList = Array.isArray(codesRaw) ? codesRaw.map(toCodeSnippet) : []
